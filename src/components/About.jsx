...
//import { image1 } from "../assets/img/A-propos-left-1.webp";
//import { image2 } from "../assets/img/A-propos-left-2.webp";
function About() {
    return (
        <div className="flex gap-36 p-36 bg-white text-blue-900">
          {/* <div className="">
                    ...
                    <img
                        src={image2}
                        alt="Image B"
                        className="absolute bottom-0 right-0 w-3/4 h-auto rounded-lg shadow-lg z-20"
                    />
                    </div>
            </div>*/}
            <div>
                <h1 className="text-4xl">À propos de nous</h1>
                <p className="flex text-2xl mt-6"><GraduationCap className="text-yellow-600"/> +3Ans</p>
                ...
                <p className="flex text-2xl mt-6"> <Users2 className="text-yellow-600"/> +250 étudiants</p>
                ...
                <p className="flex text-2xl mt-6"> <Medal className="text-yellow-600"/> Notre missions</p>
